...
module Fluent
  module Config
    def self.size_value(str)
      puts 'jinchen ----- config/types.rb : self.size_value start'
      case str.to_s
      when /([0-9]+)k/i
        $~[1].to_i * 1024
      when /([0-9]+)m/i
      ...
      puts 'jinchen ----- config/types.rb : self.size_value end'
    end

    def self.time_value(str)
      puts 'jinchen ----- config/types.rb : self.time_value start '
      case str.to_s
      when /([0-9]+)s/
        $~[1].to_i
      when /([0-9]+)m/
      ...
      puts 'jinchen ----- config/types.rb : self.time_value end'
    end

    def self.bool_value(str)
      puts 'jinchen ----- config/types.rb : self.bool_value start '
      ...
      puts 'jinchen ----- config/types.rb : self.bool_value end'
    end
