...
module Fluent
  ...
  module HandleTagNameMixin
    ...
    def configure(conf)
      puts 'jinchen ----- mixin.rb : handle-tag-name-mixin : configure'
      super
    ...
    def filter_record(tag, time, record)
      puts 'jinchen ----- mixin.rb : handle-tag-name-mixin : filter_record'
  ...
  module SetTimeKeyMixin
    ...
    def configure(conf)
      puts 'jinchen ----- mixin.rb : set-time-key-mixin : configure'
    ...
    def filter_record(tag, time, record)
      puts 'jinchen ----- mixin.rb : set-time-key-mixin : filter_record'
      super
  ...
  module SetTagKeyMixin
    ...
    def configure(conf)
      puts 'jinchen ----- mixin.rb : set-tag-key-mixin : configre'
    ...
    def filter_record(tag, time, record)
      puts 'jinchen ----- mixin.rb : set-tag-key-mixin : filter_record'
      super
