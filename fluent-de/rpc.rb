  ...
  module RPC
    class Server
      def initialize(endpoint, log)
        puts 'jinchen ----- rpc.rb : server : initialize'
      ...
      def start
        puts 'jinchen ----- rpc.rb : server : start'
      ...
      def shutdown
        puts 'jinchen ----- rpc.rb : server : shutdown'
        if @server
          @server.shutdown
          @server = nil
        end
